...
def precipitation():
    """Return a list of dates and corresponding precipitations"""
...
def tobs():
    """Return a list of dates and corresponding tobs"""
    ...
    #Calculate minimum, average and max temperature for start/start-end dates
